...
//   }, [work]);
  ...
  return (
    <div className="testimonial__container2">
      <div className="testimonial__card" key={item?.id}>
        ...
        <span className="work__button" onClick={() => showWork(item, 1)}>
          View Post{" "}
          <Icon icon="bx:right-arrow-alt" className=" work__button-icon"></Icon>
        </span>
      </div>
      <div
        className={
      ...
      >
        <div className="work__modal-content">
              ...
              return (
                <div className="skills__data" key={item2.id}>
                  {item2 === "DynamoDB" ? (
                    ...
                    <Icon icon="bxl:java" className="skills__card-icon" />
                  ) : item2 === "AWS Amplify" ? (
                    <Icon
                      icon="ion:logo-amplify"
                      className="skills__card-icon"
                    />
                  ) : item2 === "Python" ? (
                    <Icon
          ...
          {/* {work?.addressPost ? (
            <a
              href={work?.addressPost}
              className="work__button2"
              target="_blank"
              rel="noreferrer"
            >
              View Project{" "}
