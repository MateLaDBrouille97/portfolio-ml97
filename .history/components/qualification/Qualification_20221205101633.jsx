            ...
            <div className={toggleState===0?
                ...
                :"qualification__content"
                    ...
                    <div >
                        ...
                        <span className="qualification__subtitle">{item.Institute}</span>
                        <div className="qualification__calendar">
                            <i className="uil uil-calendar-alt"></i> {item.calendarBegin} - {item.calendarEnd}
                        </div>
                    </div>
                    <div>
