                   ...
                   {techno.map((item2,index)=>{
                    return(
                      <div className="skills__data" key={item2.id}>
                        {item2?.name==="DynamoDB"?<Icon icon="simple-icons:amazondynamodb"  className='skills__card-icon' />:item2?.name==="PostGreSQL"? <Icon icon="akar-icons:postgresql-fill"  className='skills__card-icon'/>:item2?.name==="Node Js"? <Icon icon="simple-icons:nodedotjs"  className='skills__card-icon' />:item2?.name==="C++/Java"?<Icon icon="bxl:java"  className='skills__card-icon'/>:item2?.name==="AWS Amplify"?<Icon icon="ion:logo-amplify"  className='skills__card-icon' />:<Icon icon="tabler:brand-python"  className='skills__card-icon'/>}
