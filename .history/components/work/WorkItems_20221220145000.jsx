                   ...
                   {techno.map((item2,index)=>{
                    return(
                      <div className="skills__data" key={item2.id}>
                        {item2==="DynamoDB"?<Icon icon="simple-icons:amazondynamodb"  className='skills__card-icon' />:item2==="PostGreSQL"? <Icon icon="akar-icons:postgresql-fill"  className='skills__card-icon'/>:item2==="Node Js"? <Icon icon="simple-icons:nodedotjs"  className='skills__card-icon' />:item2==="C++/Java"?<Icon icon="bxl:java"  className='skills__card-icon'/>:item2==="AWS Amplify"?<Icon icon="ion:logo-amplify"  className='skills__card-icon' />:<Icon icon="tabler:brand-python"  className='skills__card-icon'/>}
