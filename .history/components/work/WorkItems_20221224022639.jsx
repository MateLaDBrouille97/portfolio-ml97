    ...
    <div className={toggleState===1?"work__modal active-modal":"work__modal"}>
          <div className="work__modal-content">
            ...
            <Image src={image} alt="" className="work__modal-img" width={400} height={400}/>
             ...
             {work?.addressPost?<span href={work?.addressPost} className="work__social-icon" target="_blank" rel="noreferrer">
             View Project <Icon icon="bx:right-arrow-alt"  className=" work__button-icon"></Icon>
             </span>:
             <span className="work__social-icon" target="_blank" rel="noreferrer">
              Coming Soon<Icon icon="ic:round-av-timer" className=" work__button-icon2"></Icon> <Icon icon="ph:dots-three-outline-fill"  className=" work__button-icon3"/>
             </span>} 
            </div>
        </div>
    </div>
