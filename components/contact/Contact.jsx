        ...
        <div className="contact__content">
            ...
            <div className="contact__info">
                ...
                <div className="contact__card">
                    <Icon icon="bx:mail-send"  className="contact__card-icon"></Icon>
                    <h3 className="contact__card-title">Email</h3>
                    <span className="contact__card-data">
                        {dbUser?.email}
                    </span>
                    <a href="" className="contact__button">Write Me <Icon icon="bx:right-arrow-alt" className=" contact__button-icon"></Icon></a>
                </div>
        ...
        <div className="contact__content">
            ...
            <form className="contact__form" ref={form} onSubmit={sendEmail}>
                ...
                <div className="contact__form-div contact__form-area">
                    ...
                    <textarea name="project"  cols="30" rows="10" className="contact__form-input" placeholder="Write me your project"></textarea>
                </div>
                <button  className="button button--flex"> Send Me Message  
        <svg
